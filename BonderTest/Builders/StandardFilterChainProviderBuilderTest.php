...
final class StandardFilterChainProviderBuilderTest 
  ...
  public function testForwardGets() {
    $builder = new \Bonder\Builders\StandardFilterChainProviderBuilder();
    $filtersBuilder = $this->getMock("\Bonder\Builders\FiltersProviderBuilder");
    $controllerBuilder =
    $this->getMock("\Bonder\Builders\ControllerProviderBuilder");
    ...
    $controllerBuilder->expects($this->once())->method("getContext")
      ->willReturn($context);
   
    $controllerBuilder->expects($this->once())->method("getControllers")
      ->willReturn($controllers);
    
    $filtersBuilder->expects($this->once())->method("getFilters")
      ->willReturn($filters);
